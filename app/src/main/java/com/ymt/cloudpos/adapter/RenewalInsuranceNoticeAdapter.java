 ...
 * desc  :
 */
public class RenewalInsuranceNoticeAdapter extends RecyclerBaseAdapter<RenewalInsuranceNoticeModel> {

    public RenewalInsuranceNoticeAdapter(List<RenewalInsuranceNoticeModel> mData) {
        super(mData);
    }

    @Override
    public int getItemLayoutId(int viewType) {
        return R.layout.renewal_insurance_notice_item;
    }

    @Override
    public int getVariableId(int viewType) {
        return BR.renewalInsuranceNoticeModel;
    }
    ...
    @Override
    public void bindCustomData(RecyclerViewHolder holder, int position, RenewalInsuranceNoticeModel item) {

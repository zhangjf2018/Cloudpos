 ...
 * desc  :
 */
public class CarProductAdapter extends RecyclerBaseAdapter<CarProductModel> {

    public CarProductAdapter(List<CarProductModel> mData) {
        super(mData);
    }

    @Override
    public int getItemLayoutId(int viewType) {
        return R.layout.car_product_item;
    }

    @Override
    public int getVariableId(int viewType) {
        return BR.carProductModel;
    }
    ...
    @Override
    public void bindCustomData(RecyclerViewHolder holder, int position, CarProductModel item) {
